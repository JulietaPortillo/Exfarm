            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        {!! Form::model( $sale, [ 'route' => ['sales.update', $sale], 'method' => 'PUT', 'class' => 'form-horizontal form-material']) !!}

                        <div class="form-group">
                            {!! Form::label('code_id', 'Código animalito') !!}
                            <div class="col-md-12">
                                {!! Form::text('code_id', null, ['class' => 'form-control form-control-line', 'name' => 'code_id', 'disabled' => 'true', 'required' => 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="{{ url('/sales') }}" class="btn btn-outline-info"><i class="fa fa-arrow-left"> </i> Regresar</a>
