            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        {!! Form::model($user, [ 'route' => ['users.update', $user], 'method' => 'PUT', 'class' => 'form-horizontal form-material']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                {!! Form::text('password', null , ['class' => 'form-control form-control-line', 'name' => 'password', 'placeholder' => 'Ej: *****', 'required' => 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select name="role" class="form-control form-material" required>
                                    <option value="{{ $user->role_id }}" selected> {{ $user->role->description }} </option>
